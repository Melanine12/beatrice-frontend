      ...
      <div className="space-y-6">
        <div className="text-center">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">
            📊 Indicateurs Financiers par Devise
          </h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Chaque devise affiche ses propres indicateurs sans addition avec d'autres devises
          </p>
        </div>

        {/* Grille des indicateurs par devise */}
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded">
                ...
                <span className="text-lg font-bold text-green-600">
                  {(() => {
                    const fcPayments = stats.recentPayments ? stats.recentPayments.filter(p => p.devise === 'FC') : [];
                    const total = fcPayments.reduce((sum, p) => sum + parseFloat(p.montant || 0), 0);
                    console.log('🔍 FC Payments:', fcPayments, 'Total:', total);
              ...
              <div className="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded">
                <div className="flex items-center">
                  <BanknotesIcon className="h-5 w-5 text-red-600 mr-2" />
                ...
                <span className="text-lg font-bold text-red-600">
                  {(() => {
                    const fcExpenses = stats.expensesByCurrency ? stats.expensesByCurrency.find(item => item.devise === 'FC')?.total || 0 : 0;
                    return formatAmount(fcExpenses, 'FC');
                  })()}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded">
                ...
                <span className="text-lg font-bold text-blue-600">
                  {(() => {
                    const fcPayments = stats.recentPayments ? stats.recentPayments.filter(p => p.devise === 'FC') : [];
                    const paymentsTotal = fcPayments.reduce((sum, p) => sum + parseFloat(p.montant || 0), 0);
                    const fcExpenses = stats.expensesByCurrency ? stats.expensesByCurrency.find(item => item.devise === 'FC')?.total || 0 : 0;
                    const balance = paymentsTotal - fcExpenses;
                    return formatAmount(balance, 'FC');
                  })()}
                </span>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded">
                ...
                <span className="text-lg font-bold text-green-600">
                  {(() => {
                    const usdPayments = stats.recentPayments ? stats.recentPayments.filter(p => p.devise === 'USD') : [];
              ...
              <div className="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded">
                ...
                <span className="text-lg font-bold text-red-600">
                  {(() => {
                    const usdExpenses = stats.expensesByCurrency ? stats.expensesByCurrency.find(item => item.devise === 'USD')?.total || 0 : 0;
                    return formatAmount(usdExpenses, 'USD');
                  })()}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded">
                ...
                <span className="text-lg font-bold text-blue-600">
                  {(() => {
                    const usdPayments = stats.recentPayments ? stats.recentPayments.filter(p => p.devise === 'USD') : [];
                    const paymentsTotal = usdPayments.reduce((sum, p) => sum + parseFloat(p.montant || 0), 0);
                    const usdExpenses = stats.expensesByCurrency ? stats.expensesByCurrency.find(item => item.devise === 'USD')?.total || 0 : 0;
                    const balance = paymentsTotal - usdExpenses;
                    return formatAmount(balance, 'USD');
                  })()}
                </span>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded">
                ...
                <span className="text-lg font-bold text-green-600">
                  {(() => {
                    const eurPayments = stats.recentPayments ? stats.recentPayments.filter(p => p.devise === 'EUR') : [];
              ...
              <div className="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded">
                ...
                <span className="text-lg font-bold text-red-600">
                  {(() => {
                    const eurExpenses = stats.expensesByCurrency ? stats.expensesByCurrency.find(item => item.devise === 'EUR')?.total || 0 : 0;
                    return formatAmount(eurExpenses, 'EUR');
                  })()}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded">
                ...
                <span className="text-lg font-bold text-blue-600">
                  {(() => {
                    const eurPayments = stats.recentPayments ? stats.recentPayments.filter(p => p.devise === 'EUR') : [];
                    const paymentsTotal = eurPayments.reduce((sum, p) => sum + parseFloat(p.montant || 0), 0);
                    const eurExpenses = stats.expensesByCurrency ? stats.expensesByCurrency.find(item => item.devise === 'EUR')?.total || 0 : 0;
                    const balance = paymentsTotal - eurExpenses;
                    return formatAmount(balance, 'EUR');
                  })()}
                </span>
              </div>
            </div>
            ...
            <div key={source.source} className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="text-sm font-semibold text-gray-900 dark:text-white">
                  {source.revenue.toLocaleString()} {mainCurrency}
                </div>
                <div className="text-xs text-gray-500 dark:text-gray-400">
                  {source.percentage}%
                </div>
